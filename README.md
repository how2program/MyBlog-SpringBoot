Данное приложение является блогом с возможностью добавления постов с картинками, комментариев и оценок "мне нравится". В блоге также присутствует пагинация и возможность фильтрации постов по тегам.
